...
#define butRST_Pin GPIO_PIN_12
#define butRST_GPIO_Port GPIOA
#define butINC_Pin GPIO_PIN_13
#define butINC_GPIO_Port GPIOA
#define butDEC_Pin GPIO_PIN_14
#define butDEC_GPIO_Port GPIOA
