...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, a1_Pin|b1_Pin|c1_Pin|d1_Pin
                          |e1_Pin|f1_Pin|g1_Pin|LEDR_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : a1_Pin b1_Pin c1_Pin d1_Pin
                           e1_Pin f1_Pin g1_Pin LEDR_Pin */
  ...
  /*Configure GPIO pins : butRST_Pin butINC_Pin butDEC_Pin */
  GPIO_InitStruct.Pin = butRST_Pin|butINC_Pin|butDEC_Pin;
